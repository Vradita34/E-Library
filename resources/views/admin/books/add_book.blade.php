                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control"
                                                placeholder="Author" name="publisher" value="{{ old('publisher') }}">
                                        </div>
                                        @error('publisher')
                                            <p class="text-warning text-small">{{ $message }}</p>
                                        @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <fieldset class="form-group">
                                                <select class="form-select" id="basicSelect" name="category_id">
                                                    ...
                                                    <option value="{{$item->id}}">{{$item->name}}</option>s
                                                    @endforeach
                                                </select>
                                            </fieldset>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="int" min="1" max="200" id="first-name-column" class="form-control"
                                                placeholder="Read Duration" name="read_duration" value="{{ old('read_duration') }}">
                                        </div>
                                        @error('read_duration')
                                            <p class="text-warning text-small">{{ $message }}</p>
                                        @enderror
