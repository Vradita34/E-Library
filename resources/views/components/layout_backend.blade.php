                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div class="dropdown">
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-3">
                                            <h6 class="mb-0 text-gray-600">@auth{{Auth::user()->name}}@endauth</h6>
                                            <p class="mb-0 text-sm text-gray-600">Administrator</p>
                                        </div>
                                        <div class="user-img d-flex align-items-center">
                                            <div class="avatar avatar-md">
                                                @auth
                                                <img src="{{Auth::user()->avatar ? asset('storage/'.Auth::user()->avatar) : asset('backend/assets/compiled/jpg/1.jpg')}}">
                                                @else
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                                    ...
                                    <li>
                                        <h6 class="dropdown-header">Hello, @auth{{Auth::user()->name}}@endauth</h6>
                                    </li>
