...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__logo">
            <a href="{{route('homepage')}}"><img src="/frontend/img/logo.png" alt=""></a>
        </div>
        ...
        <div class="offcanvas__auth">
            <form action="{{route('logout')}}" method="POST">
                @csrf
                <button type="submit" class="text-small btn btn-sm btn-outline-danger">Logout</button>
            </form>
        </div>
        @endauth
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__right">
                        ...
                        @auth
                        <div class="header__right__auth">
                            <form action="{{route('logout')}}" method="POST" onsubmit="confirm('are you sure ?')">
                                @csrf
                                <button type="submit" class="text-small btn btn-sm btn-outline-danger">Logout</button>
                            </form>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-7">
                    <div class="footer__about">
                        ...
                        <div class="footer__payment">
                            <a href="#"><img src="/frontend/img/payment/payment-1.png" alt=""></a>
                            <a href="#"><img src="/frontend/img/payment/payment-2.png" alt=""></a>
                            <a href="#"><img src="/frontend/img/payment/payment-3.png" alt=""></a>
                            <a href="#"><img src="/frontend/img/payment/payment-4.png" alt=""></a>
                            <a href="#"><img src="/frontend/img/payment/payment-5.png" alt=""></a>
                        </div>
                    </div>
                </div>
